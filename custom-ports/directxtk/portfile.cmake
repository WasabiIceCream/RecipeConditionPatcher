...
# fxc.exe and everything works unmodified. On our Linux cross-compile,
# there is no such fxc.exe to find, so pre-set DIRECTX_FXC_TOOL to our
# patched fxc2 (built from extern/fxc2/, run under Wine via the
# wine-shader-compile.patch applied above) - find_program() does not
# override an already-set cache variable, so this makes DirectXTK's own
# LegacyShaderCompiler wiring pick it up with no further changes needed.
# See RecipeConditionPatcher's top-level CMakeLists.txt for where
# extern/fxc2/fxc2.exe actually gets built.
if(CMAKE_HOST_UNIX)
    set(DIRECTXTK_FXC2_OPTIONS "-DDIRECTX_FXC_TOOL=${CMAKE_CURRENT_LIST_DIR}/../../extern/fxc2/fxc2.exe")
else()
